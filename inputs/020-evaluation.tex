...
both clusterings + \(N_{00}\): the number of pairs that do not co-occur
in either clustering + \(N_{10}\) or \(N_{01}\): the number of pairs
that co-occur in one clustering but not the other.
